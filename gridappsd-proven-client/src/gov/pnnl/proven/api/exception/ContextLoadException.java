...
/**
 * An <code>ContextRegistrationException</code> is an <code>Exception</code>
...
public class ContextLoadException extends RuntimeException {
	...
	/**
     * Constructs an <code>ContextRegistrationException</code> with no specified
     * detail message.
     */
    public ContextLoadException() {}

    /**
     * Constructs an <code>ContextRegistrationException</code> with the specified
     * detail message.
     */
    public ContextLoadException(String s)
    {
        super(s);
    }
}
